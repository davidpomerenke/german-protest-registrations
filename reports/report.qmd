...
Multiple approaches have already been used for the creation of datasets on protests in Germany. Table XYZ gives an overview about the existing and new datasets.
...
1. The __2018-2022 dataset__ contains only cities that have coverage throughout 2018-2022, and that also have the number of registered participants available. This results in a large dataset (about 40.000 entries) that strikes a balance between regional diversity (5 cities) and time coverage (4 years).
